...
"""
U-Net Modules for spatial and spatiotemporal data.

This module implements U-Net architectures for multi-scale feature extraction:
- UNet2D: For 2D spatial data (Height × Width)
- UNet3D: For 3D spatiotemporal data (Height × Width × Time)

These can be used as standalone architectures or as components in hybrid models
like U-FNO and U-DeepONet.
